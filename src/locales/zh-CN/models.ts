export default {
  ...
  'models.table.metrics': '指标',
  'models.table.lifecycle': '生命周期',
  'models.table.waiting': '等待状态',
  'models.table.avgRequestRate': '请求率',
  'models.table.avgProcessRate': '处理率',
  'models.table.requestProcessRate': '请求/处理率',
  'models.table.requestProcessRate.tips':
    '基于过去2分钟的请求和处理数据计算请求率和处理率（每15秒更新一次）',
  'models.table.runtimeLoad': '实时负载',
  'models.table.runtimeLoad.tips':
    '从推理后端采集的运行时指标：正在处理 / 排队请求数、负载率（vLLM 为 KV 缓存占用，llama.cpp 为并发 slot 占用）、请求率、TTFT、TPOT、输出吞吐（每 30 秒更新）。鼠标悬停查看详细数据。',
  'models.table.runtimeLoad.loadSourceVllm': 'KV 缓存占用率',
  'models.table.runtimeLoad.loadSourceLlamaCpp': '并发 slot 占用率',
  'models.table.runtimeLoad.running': '正在处理',
  'models.table.runtimeLoad.waiting': '排队中',
  'models.table.runtimeLoad.kvAvg': 'KV 缓存占用',
  'models.table.runtimeLoad.load': '负载',
  'models.table.runtimeLoad.reqRate': '请求率',
  'models.table.runtimeLoad.throughput': '输出吞吐',
  'models.table.runtimeLoad.ttft': '首 Token 延迟',
  'models.table.runtimeLoad.tpot': '出 Token 延迟',
  'models.table.runtimeLoad.refresh': '立即刷新',
  'models.table.runtimeLoad.waitingData': '等待数据...',
  'models.table.runtimeLoad.updatedAt': '更新于 {time}',
  'models.table.lastUsed': '最近使用',
  'models.table.lastUsed.never': '从未',
  ...
  'models.form.autoLoad': '自动加载',
  'models.form.autoLoad.tips': '当收到请求且没有就绪实例时，自动启动副本。',
  'models.form.autoLoadReplicas': '自动加载副本数',
  'models.form.autoLoadReplicas.tips':
    '触发自动加载时要启动的副本数量；同时也是“自动调整副本数”的扩容上限。',
  'models.form.autoAdjustReplicas': '自动调整副本数',
  'models.form.autoAdjustReplicas.tips':
    '允许系统根据实时流量自动扩缩副本数量：扩容上限为“自动加载副本数”，缩容下限为 1。若需要扩容生效，请将“自动加载副本数”设为大于 1。',
  'models.form.scaleWindowMinutes': '扩缩容观察窗口（分钟）',
  'models.form.scaleWindowMinutes.tips':
    '触发扩容或缩容的条件必须持续满足该时长。冷却时间为窗口的一半。',
  'models.form.scaleDownKvThreshold': '缩容 KV 阈值',
  'models.form.scaleDownKvThreshold.tips':
    '当队列为空且预计减少一副本后的平均 KV 缓存占用率低于该阈值时，触发缩容。',
  'models.form.autoUnload': '自动卸载',
  'models.form.autoUnload.tips': '在达到配置的空闲超时后自动停止空闲副本。',
  'models.form.autoUnloadTimeout': '自动卸载超时（分钟）',
  'models.form.autoUnloadTimeout.tips': '模型空闲多少分钟后会被自动卸载。',
  'models.form.gpuMemoryMinGib': 'GPU 显存下限（GiB）',
  'models.form.gpuMemoryMinGib.tips':
    '为每张参与该模型的 GPU 设置最少占用的绝对显存（GiB）。设置后会反推出有效的 --gpu-memory-utilization（覆盖用户手动设置的值），并与上限一起对 vLLM 调度与启动生效。支持一位小数（如 13.5）。留空表示不设下限。',
  'models.form.gpuMemoryMaxGib': 'GPU 显存上限（GiB）',
  'models.form.gpuMemoryMaxGib.tips':
    '为每张参与该模型的 GPU 设置最多占用的绝对显存（GiB）。设置后会反推出有效的 --gpu-memory-utilization（覆盖用户手动设置的值）。与下限相等即固定值。支持一位小数（如 13.5）。留空表示不设上限。',
  'models.form.waitingFirstScaling': '等待第一次自动调整',
  'models.form.monitoringLoad': '监控负载中',
  'models.form.checkingReplicasChange': '获取副本数变化中...',
  'models.form.replicasChangeNoChange': '副本数不变',
  'models.form.scaleCooldown': '冷却中',
  'models.form.scaleTriggerCountdown': '后触发',
  'models.form.waitingUnloading': '等待卸载中...',
